        ...
        >
          <div class="pr-10">
            <div
              ...
              :class="preferences.isDark ? 'bg-sky-500/12 text-sky-300' : 'bg-sky-100 text-sky-700'"
            >
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <span
                  class="text-xs"
                  :class="preferences.isDark ? 'text-slate-500' : 'text-slate-400'"
                >
                  {{ bio.length }}/160
                </span>
              </div>
