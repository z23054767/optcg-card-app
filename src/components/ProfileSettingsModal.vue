<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 py-6">
    <div
      class="flex max-h-[90vh] w-full max-w-md flex-col overflow-hidden rounded-xl bg-white shadow-xl"
    >
      <div class="flex shrink-0 items-center justify-between border-b px-5 py-4">
        ...
        <button
          class="text-xl text-gray-400 hover:text-gray-600 disabled:opacity-50"
          :disabled="saving"
          @click="$emit('close')"
        >
          ✕
      ...
      <div class="min-h-0 flex-1 overflow-y-auto px-5 py-4">
        ...
        <p v-if="isThirdPartyAccount" class="mt-2 text-xs text-gray-500">
