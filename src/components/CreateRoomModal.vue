  ...
  >
    <div class="w-full max-w-md rounded-xl bg-white shadow-lg">
      <div class="flex items-center justify-between border-b px-5 py-4">
        <h2 class="text-base font-semibold text-gray-800">建立群組聊天室</h2>
      ...
      <div class="p-5">
        <div>
          <label class="mb-1 block text-sm text-gray-600"> 群組名稱 </label>
        ...
        <div class="mt-5 flex justify-end gap-2">
          ...
          <button
            class="rounded-lg bg-blue-600 px-3 py-1.5 text-sm text-white disabled:opacity-50"
