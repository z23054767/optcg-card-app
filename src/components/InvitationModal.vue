      ...
      >
        ...
        <div class="max-h-[70vh] overflow-y-auto px-5 py-5 sm:px-6">
          <div
            ...
            :class="preferences.isDark ? 'border-white/10 bg-white/3' : 'border-slate-200 bg-white'"
          >
            <div
          ...
          <section v-if="friendRequests.length > 0">
            ...
            <div
              ...
              :class="
                preferences.isDark ? 'border-white/8 bg-white/3' : 'border-slate-200 bg-white'
              "
            >
            ...
            >
              <div class="flex items-center gap-3">
                ...
                >
                  <img
                    v-if="
                      getRoomAvatarUrl(invitation) &&
                      !roomAvatarLoadFailedIds.has(invitation.invitationId)
                    "
                    :src="getRoomAvatarUrl(invitation) ?? ''"
                    :alt="`${invitation.roomName ?? '群組'} 頭像`"
                    class="h-full w-full object-cover"
                    @error="markRoomAvatarLoadFailed(invitation.invitationId)"
                  />
                  <span v-else>👥</span>
                </span>
